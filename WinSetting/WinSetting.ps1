...
function CHG_Setting {
    ...
    # 桌面圖示 - 控制台
    reg add "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Explorer\HideDesktopIcons\NewStartPanel" /v "{018D5C66-4533-4307-9B53-224DE2ED1FE6}" /t REG_DWORD /d 1 /f
    # 桌面圖示 - 資源回收桶
